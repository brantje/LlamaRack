...
func newPhase10Fixture(t *testing.T) *phase10Fixture {
	t.Helper()
...
func TestPhase10RequiresAuthenticationAndExposesProfile(t *testing.T) {
...
func TestPhase10UserManagementSafeguardsAndSessionCounts(t *testing.T) {
	f := newPhase10Fixture(t)
...
func TestPhase10SelfServicePasswordAndSessions(t *testing.T) {
	f := newPhase10Fixture(t)
...
func TestPhase10GeneralSettingsSummaryAndSystem(t *testing.T) {
	f := newPhase10Fixture(t)
