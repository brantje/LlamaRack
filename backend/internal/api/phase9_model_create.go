...
type phase9ModelCreateHandler struct {
	next   http.Handler
	models *models.Service
}

func NewPhase9ModelCreateHandler(next http.Handler, modelService *models.Service) http.Handler {
	return &phase9ModelCreateHandler{next: next, models: modelService}
}

func (h *phase9ModelCreateHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
...
func (h *phase9ModelCreateHandler) refreshModelResponse(r *http.Request, body []byte) []byte {
