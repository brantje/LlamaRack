...
func TestOIDCFrontendURLSetting(t *testing.T) {
	...
	w = adminRequest(t, f.secured, http.MethodPut, "/api/v1/admin/auth/settings", map[string]any{"frontend_url": "http://192.168.60.5:3000"}, nil, f.headers())
	...
	w = adminRequest(t, f.secured, http.MethodPut, "/api/v1/admin/auth/settings", map[string]any{"frontend_url": "javascript:alert(1)"}, nil, f.headers())
	...
	w = adminRequest(t, f.secured, http.MethodPut, "/api/v1/admin/auth/settings", map[string]any{"frontend_url": ""}, nil, f.headers())
