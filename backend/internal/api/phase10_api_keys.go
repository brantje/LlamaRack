...
type phase10APIKeysHandler struct{ auth *auth.Service }

func NewPhase10APIKeysHandler(a *auth.Service) http.Handler { return &phase10APIKeysHandler{auth: a} }

func (h *phase10APIKeysHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
...
func (h *phase10APIKeysHandler) collection(w http.ResponseWriter, r *http.Request, user auth.User) {
	switch r.Method {
	case http.MethodGet:
...
func (h *phase10APIKeysHandler) item(w http.ResponseWriter, r *http.Request, user auth.User, rest string) {
...
func (h *phase10APIKeysHandler) revoke(w http.ResponseWriter, r *http.Request, user auth.User, id string) {
...
func writeAPIKeyPhase10Error(w http.ResponseWriter, err error) {
