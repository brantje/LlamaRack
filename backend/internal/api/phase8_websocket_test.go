...
func TestPhase8DownloadWebSocketStreamsJobUpdates(t *testing.T) {
...
func TestPhase8DownloadWebSocketRequiresGet(t *testing.T) {
	fixture := newPhase8Fixture(t)
	if got := phase8Request(t, fixture, http.MethodPost, "/api/v1/downloads/ws", nil, true).Code; got != http.StatusMethodNotAllowed {
