...
func NewModelMetadataValueHandler(a *auth.Service, modelService *models.Service) http.Handler {
	return &modelMetadataValueHandler{auth: a, models: modelService}
}

func (h *modelMetadataValueHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
