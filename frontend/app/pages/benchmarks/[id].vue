...
<template>
  <div class="space-y-6">
    ...
    <template v-else-if="run">
      ...
      <section class="space-y-3">
        <div><h2 class="text-base font-semibold">Measurements</h2><p class="mt-1 text-xs text-muted">Standalone prompt, generation, and combined-turn cases remain distinct. Context depth is the KV cache prefill depth used before the measured case.</p></div>
