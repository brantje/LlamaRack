...
- Bind-mounted data directories the process cannot `chmod` (GitHub Actions smoke volumes owned by the host user) no longer fail startup; SQLite files are still restricted to `0600`.
